...
namespace TestCoreWebAPI.Controllers
{
	...
	public class AssignmentDetailController: Controller
    {
		...
		private readonly AssignmentDetailContext _context;
		public AssignmentDetailController(AssignmentDetailContext context)
		{
			_context = context;
		...
		[HttpPost]
		public IActionResult Create([FromBody] AssignmentDetailItem item)
		{
		...
		//GET /api/AssignmentDetail
        //GET /api/AssignmentDetail/{id}
		[HttpGet]
		public IEnumerable<AssignmentDetailItem> GetAll()
		{
			...
			return _context.AssignmentDetailItems.ToList();
		}
		[HttpGet("{id}", Name = "GetAssignmentDetail")]
		...
		public IActionResult Delete(long id)
		{
			...
			_context.AssignmentDetailItems.Remove(AssignmentDetail);
			_context.SaveChanges();
			return new NoContentResult();
		}
